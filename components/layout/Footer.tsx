  ...
  return (
    <footer className="bg-bg-primary border-t border-border-card">
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        {/* Top grid: Centered on mobile, Left-aligned on Desktop */}
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            <Link
              href="/"
              className="gradient-text text-xl font-bold tracking-tight w-fit"
            >
              Crypsight
            </Link>
            <p className="text-sm leading-relaxed text-text-secondary max-w-xs md:max-w-50">
              Leading the next generation of on-chain intelligence for the
              global architect.
            </p>
            {/* Social icons */}
          ...
          {footerLinks.map((column) => (
            <div key={column.heading} className="flex flex-col items-center md:items-start gap-4">
        ...
        <div className="mt-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between text-center md:text-left">
          <p className="text-[10px] md:text-xs tracking-widest text-text-muted uppercase">
